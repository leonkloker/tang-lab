...
# data where ref values are the values when using all features
...
# iterate over all frequncies and read out the results
for f1 in range(1,7):
...
# calculate the differences to the reference values
...
#plt.show()
plt.savefig("figures/final_paper/frequency_ablation_r.pdf")
...
plt.xticks(rotation=90)
#plt.show()
plt.savefig("figures/final_paper/frequency_ablation_mae.pdf")
...
plt.xticks(rotation=90)
#plt.show()
plt.savefig("figures/final_paper/frequency_ablation_f1.pdf")

...
for f1 in range(1,7):
    for f2 in range(f1+1,7):
        ...
        with open('results/15_fold_mean_unnormalized_freqs{}{}.txt'.format(f1,f2), 'r') as file:
            for line in file:
...
#plt.show()
plt.savefig("figures/final_paper/frequency_two_ablation_r.pdf")
...
plt.xticks(rotation=90)
#plt.show()
plt.savefig("figures/final_paper/frequency_two_ablation_mae.pdf")
...
plt.xticks(rotation=90)
#plt.show()
plt.savefig("figures/final_paper/frequency_two_ablation_f1.pdf")

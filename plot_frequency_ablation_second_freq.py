...
#plt.show()
plt.savefig("figures/final_paper/frequency_ablation_r_2nd.pdf")
...
plt.xticks(rotation=90)
#plt.show()
plt.savefig("figures/final_paper/frequency_ablation_mae_2nd.pdf")
...
plt.xticks(rotation=90)
#plt.show()
plt.savefig("figures/final_paper/frequency_ablation_f1_2nd.pdf")

...
file_train = './data/25_populations_{}_combinations_precomputed_trainset_antiIge_{}.pickle'.format(combinations, "_".join(features))
file_test = './data/11_populations_precomputed_testset_antiIge_{}.pickle'.format("_".join(features))

...
# Load the data
with open('results/pdf_sampling_range_ablation_cd63.pickle', 'rb') as f:
    data_cd63 = pickle.load(f)

with open('results/pdf_sampling_range_ablation_avidin.pickle', 'rb') as f:
    data_avidin = pickle.load(f)

with open('results/pdf_sampling_range_ablation_cd203c_dMFI*.pickle', 'rb') as f:
...
mae_ridge_cd203c = data_cd203c["mae_ridge"] / 14.07
r_ridge_cd203c = data_cd203c["r_ridge"]

# Plot the data
x = np.linspace(0.2,3.0,29)
...
plt.xlabel('Sampling range', fontsize=12)
